    ...
    <div>
      ...
      {promoCodes.length === 0 ? (
        <Card className="text-center py-12">
          ...
          <p className="text-gray-600 mb-4">Create your first promo code to offer discounts.</p>
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    <button
                      ...
                      className="font-mono text-xl font-bold text-[var(--color-primary)] hover:opacity-80 transition-colors flex items-center gap-2"
                    >
                      {code.code}
                      {copiedId === code.id ? (
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      className="w-4 h-4 rounded border-gray-300 bg-white text-[var(--color-primary)] focus:ring-[var(--color-primary)]"
                    />
                    <label htmlFor="show_on_checkout" className="text-gray-700">
